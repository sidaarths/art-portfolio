...
export const artworks: Artwork[] = [
  // ── Eerie Chills ─────────────────────────────────────────────────────────
  {
    ...
    image: '/art/eerie-chills/unknown.jpeg',
    featured: false,
    order: 1,
  },
  {
  ...
  {
    id: 'ec3',
    slug: 'hypnosis-motion',
    title: 'Hypnosis — Motion',
    category: 'eerie-chills',
    ...
    image: '/art/eerie-chills/hypnosis-motion.jpeg',
  ...
  },
  {
    ...
    caption:
      'Public and private space can be subjective, an example of which is my piece. Individuals that have bowel issues, are queer or even victims can find it difficult to walk into a public bathroom carrying that eerie discomfort felt before while in contrast walk with a pep in their step as they use a comfortable warm one at home. (Paired with Unknown)',
    image: '/art/familiar-warmth/intimate.jpeg',
    featured: true,
    order: 2,
  },
  {
  ...
  {
    id: 'fd1',
    slug: 'creation-of-naps',
    title: 'Creation of Naps',
    ...
    image: '/art/figure-drawing/creation-of-naps.jpg',
    featured: false,
    order: 1,
  },
  {
  ...
  },
  {
    ...
    image: '/art/figure-drawing/elegance.jpg',
    featured: true,
    order: 4,
  },
  {
    id: 'fd5',
    slug: 'feeling-himself',
    ...
    image: '/art/figure-drawing/feeling-himself.jpg',
    featured: false,
    order: 5,
  },
  ...
  // ── Sunshine Daisies (Mental Health) ──────────────────────────────────────
  {
    ...
    image: '/art/sunshine-daisies/solitude.png',
    featured: true,
    order: 1,
  },
  {
  ...
  },
  {
    ...
    image: '/art/the-peacekeeper/iathorial.png',
    featured: false,
    order: 3,
  },
  {
  ...
  {
    id: 'pp1',
    slug: 'the-vulture-and-the-scapegoat',
    title: 'The Vulture and the Scapegoat',
